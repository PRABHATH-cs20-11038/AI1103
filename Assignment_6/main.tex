...
Let $X_i \in \{0, 1\}$ represent the $i^{Th}$ item where $1$ denotes the item is defective. Then, $X_i$ has a Bernoulli distribution with parameter
\begin{align}
...
\end{align}
Where $n$ is the total no. of items chosen. Then $X$ has a Binomial Distribution. Then for 
\begin{align}
...
\end{split}
\end{align}
The probability of getting $k$ defective items is,
\begin{align}
   \pr{X=k} =
  \begin{cases}
...
\begin{align}
    n=10
\end{align}
Probability of getting exactly $2$ items defective,
\begin{align}
