...
\begin{table}[h!]
\centering
\caption{Table of probability of selecting boxes}
\resizebox{.5\textwidth}{!}{
  \begin{tabular}{|m{3cm}|c|c|}
    \hline
    $\pr{Y=1}$ & $\pr{B_1}=\pr{Y=1}$ & $\pr{B_1}=\frac{2}{3}$ \\
    \hline
    $\pr{Y=0}=1-\pr{Y=1}$ & $\pr{B_2}=\pr{Y=0}$ & $\pr{B_2}=\frac{1}{3}$ \\
    \hline
    \end{tabular}
  \label{Table1}
}
...
\resizebox{.5\textwidth}{!}{
  ...
  \hline
    bag & no. of red balls $(i+2)$ & no. of white balls $(5-i-1)$ & total balls\\
    \hline
...
\resizebox{.5\textwidth}{!}{
  ...
  \hline
    bag & Probability of taking red ball & Probability of taking white ball\\
    \hline
...
\resizebox{.5\textwidth}{!}{
  \begin{tabular}{|m{5cm}|c|}
    ...
    Equation & Value\\
    \hline
    $\pr{(C=0,C=1)|B_1}=\pr{C=0|B_1}.\pr{C=1|B_1}+\pr{C=1|B_1}.\pr{C=0|B_1}$ & $\frac{1}{2}$\\
    \hline
    $\pr{(C=0,C=1)|B_2}=\pr{C=0|B_2}.\pr{C=1|B_2}+\pr{C=1|B_2}.\pr{C=0|B_2}$ & $\frac{4}{9}$\\
    \hline
  \end{tabular}
  \label{Table5}
}
